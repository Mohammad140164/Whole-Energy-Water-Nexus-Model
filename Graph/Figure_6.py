...
# ---------------- LABELS ----------------
axes[0,0].set_ylabel("Deviation in Water Consumption ($10^9$ litres)",fontsize=14, fontweight='bold')
axes[0,1].set_ylabel("Deviation in Water Consumption ($10^9$ litres)", fontsize=14, fontweight='bold')

axes[0,2].set_ylabel("Total Data Centre Water Consumption ($10^9$ litres)",fontsize=14, fontweight='bold')

for ax in axes[1,:]:
    ax.set_ylabel("Deviation in Energy Generation (TWh)", fontsize=14, fontweight='bold')
